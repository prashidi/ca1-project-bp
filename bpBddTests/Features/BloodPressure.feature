...
# EMERGENCY CONDITIONS
  ...
  Scenario: Detect emergency systolic
    Given a systolic pressure of 185
    And a diastolic pressure of 90
    When I calculate the blood pressure
    Then emergency status should be true

  Scenario: Not emergency
    Given a Systolic pressure of 120
    And a diastolic pressure of 80
    When I calculate the blood pressure
    Then emergency status should be false
